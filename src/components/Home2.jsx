      ...
      <section class="events-section">
        ...
        <div class="events-grid">
          <div class="event-card">
            <img src="/assets/workshop2.webp" alt="Workshop 2" loading="lazy" />
            <div class="event-info">
              <p>Sreenidhi School</p>
            </div>
          </div>
          <div class="event-card">
            <img src="/assets/rv24.webp" alt="Event 1" loading="lazy" />
            <div class="event-info">
              <p>ROBOVEDA 2024</p>
            </div>
          </div>
          <div class="event-card">
            <img src="/assets/workshop1.webp" alt="Workshop 1" loading="lazy" />
            <div class="event-info">
              <p>Drone Workshop</p>
            </div>
          </div>
